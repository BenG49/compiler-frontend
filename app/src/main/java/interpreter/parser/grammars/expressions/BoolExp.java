...
public class BoolExp {
     ...
     *                 | boolterm
     */
    public static ASTNode<?> BoolExpression(Parser p, SymbolTable t) throws InterpretException {
     ...
     *           | boolfactor
     */
    public static ASTNode<?> BoolTerm(Parser p, SymbolTable t) throws InterpretException {
     ...
     *             | variable
     */
    public static ASTNode<?> BoolFactor(Parser p, SymbolTable t) throws InterpretException {
        Type nextType = p.l.nextType();
